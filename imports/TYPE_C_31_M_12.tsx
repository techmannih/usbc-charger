    ...
    <connector
      ...
      schPinArrangement={{
        leftSide: {
          ...
          pins: ["CC1", "CC2", "DP1", "DN1", "DP2", "DN2", "SBU1", "SBU2"],
        },
        rightSide: {
          direction: "top-to-bottom",
          pins: ["VBUS1", "VBUS2", "GND1", "GND2", "SH1", "SH2", "SH3", "SH4"],
        },
      }}
      supplierPartNumbers={{
  "jlcpcb": [
...
<courtyardoutline outline={[{"x":-5.174805999999876,"y":3.0786011999998664},{"x":5.180394000000092,"y":3.0786011999998664},{"x":5.180394000000092,"y":-5.650998800000025},{"x":-5.174805999999876,"y":-5.650998800000025},{"x":-5.174805999999876,"y":3.0786011999998664}]} />
      ...
      cadModel={{
        ...
        modelOriginPosition: { x: 0, y: -2.33500289000000517, z: 0.000010999999999872223 },
      }}
      {...props}
    />
  )
